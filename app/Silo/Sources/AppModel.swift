...
struct TerminalLauncher {
    ...
    func open(
        ...
        let scriptURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("silo-\(UUID().uuidString).command")
        do {
    ...
    private func openGhostty(
        ...
        guard let script = NSAppleScript(source: Self.ghosttyScript(
            ...
            throw LaunchError.openFailed("Silo could not prepare the Ghostty command.")
        }
...
final class AppModel {
    ...
    private func failOperation(
        ...
        emitNotification(
            ...
            deepLink: workspace.map { workspaceDeepLink($0, section: "activity") } ?? "silo://activity"
        )
    }
    ...
    private func markOperationUnknown(
        ...
        emitNotification(
            ...
            deepLink: operation.workspace.map { workspaceDeepLink($0, section: "activity") } ?? "silo://activity"
        )
    }

# MSW Monitor for macOS 26+: native setup, GitHub App OAuth, and menu-bar operations

**Status:** implementation plan

**Target:** macOS 26 or later, Apple Silicon, direct Developer ID distribution

**Working product name:** MSW Monitor
...
```json
{
  ...
  "error": {
    ...
    "recovery": "Run Setup in MSW Monitor.",
    "workspace": null,
    "retryable": false
  }
}
...
```text
app/MSWMonitor/
  MSWMonitor.xcodeproj
  Sources/MSWMonitorApp/
    AppDelegate.swift
